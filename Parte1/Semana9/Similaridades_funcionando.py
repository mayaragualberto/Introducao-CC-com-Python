...
def avalia_textos(textos, ass_cp):
    ...
    for i in range( 0, len(textos)):
        similaridade = compara_assinatura(ass_cp, textos[i])
        #print(similaridade)
...
def main():
    ...
    textos=le_textos()
    contador=0
    ass_textos_recebidos=[]
    ass_textos_recebidos_total=[]
    while contador>len(textos):
        ass_textos_recebidos=calcula_assinatura(textos[contador])
        ass_textos_recebidas_total=ass_textos_recebidos.append(calcula_assinatura(textos[contador]))
        contador += 1
    copia=avalia_textos(ass_textos_recebidos_total,assinatura)
